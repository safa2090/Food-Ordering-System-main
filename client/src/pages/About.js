      ...
      <Layout title={"About us - UniDeals"}>
        <div className="about my-5">
          ...
          <div className="about-info">
            ...
            <p className="description">
              Behind <span className='site-title'>DineDrop</span> is a team of passionate individuals who share a common vision: to revolutionize the way you shop online. We work tirelessly to ensure that our platform is always up-to-date with the latest trends and innovations to meet your ever-changing needs.
            </p>
            ...
            <p className='description'>
              ...
              Thank you for choosing <span className='site-title'>DineDrop</span>. Happy shopping!
            </p>
          </div>
        </div>
      </Layout>
